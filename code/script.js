...
const start = () => {
  ...
  // JENNIES KOMMENTAR FRÅN FILMEN: set the secret person -> invoke setSecret function
  // JENNIES KOMMENTAR FRÅN FILMEN: show the board on the screen -> invoke generateBoard funktion
}
