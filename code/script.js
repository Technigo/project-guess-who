...
const checkQuestion = () => {
  ...
  if (category === 'hair' || category === 'eyes') {
    ...
    if (questions.value == secret.accessories == true) {
      filterCharacters()
    }
  }
  ...
  const filterCharacters = (keep) => {
    ...
    if (category === 'hair') {
      if (keep) {
        ...
        if (keep) {
          alert(
            `Yes, the person has ${value} color! Keep all people that has ${value} color`
          )
        } else {
          alert(
            `No, the person doesn't have ${value} color! Remove all people that has ${value} color`
          )
        }
