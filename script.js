...
const setSecret = () => {
	...
	console.log(secret); //left this console.log for you who are to lazy to actually play
};
...
const filterCharacters = (keep) => {
	...
	if (category === "accessories") {
		...
		if (keep) {
			alert(`Yes, the person does ${label}! Keep all people that ${label}`);
			charactersInPlay = charactersInPlay.filter((person) =>
				person[category].includes(value)
			);
		} else {
			alert(`No, the person doesn't ${label}! Remove all people that ${label}`);
			charactersInPlay = charactersInPlay.filter(
				(person) => !person[category].includes(value)
			);
		}
		...
		if (keep) {
			alert(`Yes, the person have ${label}! Keep all people that has ${label}`);
			charactersInPlay = charactersInPlay.filter((person) =>
				person[category].includes(value)
			);
		} else {
